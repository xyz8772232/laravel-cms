...
(function (factory) {
	...
	function Sortable(el, options) {
		...
		/*
		 * Update by Benjamin Grapeloux : Add condition for MSPointerEvents, if its true, use event pointerdown
		 * */
	...
	Sortable.prototype = /** @lends Sortable.prototype */ {
		...
		_onTapStart: function (/** Event|TouchEvent */evt) {			
			...
			/*
			 * Update by Benjamin Grapeloux : if it is a PointerObject, the structure of the object is not the same and the properties of evt.touches[0] are on the 1st level
			 * */
			if(evt.pointerType == 'touch') touch = evt;
		...
		_onDragStart: function (/**Event*/evt, /**boolean*/useFallback) {
			...
			if (useFallback) {
				...
				if (useFallback === 'touch') {
					...
					/*
					 * Update by Benjamin Grapeloux : Add PointerEvents
					 * */
